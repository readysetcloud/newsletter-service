...
export interface SponsorPhotoUploadProps {
  sponsorId?: string;
  currentPhoto?: string;
...
export const SponsorPhotoUpload: React.FC<SponsorPhotoUploadProps> = ({
  currentPhoto,
  onPhotoChange,
  onPhotoRemove,
  isUploading = false,
  ...
  const processFile = useCallback((file: File) => {
    const validationResult = validateSponsorLogoFile(file);
    if (validationResult) {
