/**
 * Shared helpers for rendering a subscriber's interest profile — the per-topic
 * interest scores accumulated from link clicks that also drive auto-segmentation.
 *
 * Used by both the Segments member view and the Subscribers list/profile view so
 * the same topic labels, sorting, and recency styling appear everywhere.
 */
...
/** Auto-segmentation fires when a topic's score reaches this threshold. */
