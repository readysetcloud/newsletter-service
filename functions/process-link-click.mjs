...
import { processInterestScoring, findOrCreateInterestSegment } from "./utils/interest-scoring.mjs";
import { ulid } from "ulid";
import crypto from "crypto";
import zlib from "zlib";

// Interest scoring / auto-segmentation now lives in ./utils/interest-scoring.mjs
// so the SES email-click handler can share it. Re-exported here to preserve the
// existing import paths used by this module's tests.
export { processInterestScoring, findOrCreateInterestSegment };
